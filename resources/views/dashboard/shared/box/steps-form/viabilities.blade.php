    ...
    <section>
        ...
        <div class="row">
            <div class="form-group col-xs-12 col-md-12">
                <label for="viability[establishment_has_avcb_clcb]">Estabelecimento possuí AVCB ou CLCB (licença do corpo de bombeiros)?</label>
            ...
            <div class="form-group col-xs-12 col-md-3 hidden">
                <label for="viability[avcb_clcb_number_type]">É AVCB ou CLCB?</label>
                <select id="viability[avcb_clcb_number_type]" name="viability[avcb_clcb_number_type]" disabled>
                    @foreach(Gcr\Viability::attributeOptions('avcb_clcb_number_type') as $value => $label)
                        <option value="{{ $value }}" @if(optional($viability)->avcb_clcb_number_type === $value) selected @endif>{{ $label }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group col-xs-12 col-md-3 hidden">
                ...
                <input id="viability[avcb_clcb_number]" name="viability[avcb_clcb_number]" type="text" class="form-control" value="{{ optional($viability)->avcb_clcb_number }}" disabled>
            </div>
